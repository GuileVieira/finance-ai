...
│ │ │  156 transações │ │  234 transações │ │   12 transações │     │ │
...
│ │ │   45 transações │ │   28 transações │ │   15 transações │     │ │
...
│ │ │   89 transações │ │   34 transações │ │   #C2410C  │     │ │
│ │ │  R$ 45.600  │ │  R$ 8.900   │ │   22 transações │     │ │
...
│ │                                                     │ │
│ │ 🏦 SALÁRIOS              R$ 28.500   156 transações     │ │
│ │ 🏠 ALUGUEL               R$ 12.500   12 transações      │ │
│ │ 💻 SOFTWARES             R$ 4.200    8 transações       │ │
│ │ 📱 TELEFONES MÓVEIS      R$ 1.800    34 transações      │ │
│ │ ⚡ ENERGIA ELÉTRICA      R$ 1.500    1 transações       │ │
│ │ 📦 MATERIAL EMBALAGEM    R$ 1.200    23 transações      │ │
│ │ 🚚 OPERADORES LOGÍSTICOS R$ 900      5 transações       │ │
│ │ 🧼 CONSERVAÇÃO/LIMPEZA   R$ 800      4 transações       │ │
│ │                                                     │ │
│ └─────────────────────────────────────────────────────┘ │
│                                                         │
│ ┌─────────────────────────────────────────────────────┐ │
