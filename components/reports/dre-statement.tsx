                ...
                <div key={item.label} className="border-b border-border pb-3 last:border-0">
                  ...
                  {item.drilldown && item.drilldown.length > 0 && (
                    <div className="space-y-2 ml-4">
                      ...
                      {item.drilldown.slice(0, 5).map((transaction: any) => (
                        <div
                          key={transaction.id}
        ...
        <CardContent className="space-y-4">
          ...
          <div className="bg-muted rounded-lg p-6">
            ...
            {formatDRELine(
              ...
              data.lineDetails?.grossRevenue?.reduce((sum: number, item: any) => sum + (item.transactions || 0), 0)
            )}
            ...
            {formatDRELine(
              ...
              data.lineDetails?.taxes?.reduce((sum: number, item: any) => sum + (item.transactions || 0), 0)
            )}
            ...
            {formatDRELine(
              ...
              data.lineDetails?.financialCosts?.reduce((sum: number, item: any) => sum + (item.transactions || 0), 0)
            )}
            ...
            {formatDRELine(
              ...
              data.lineDetails?.variableCosts?.reduce((sum: number, item: any) => sum + (item.transactions || 0), 0)
            )}
            ...
            {formatDRELine(
              ...
              data.lineDetails?.fixedCosts?.reduce((sum: number, item: any) => sum + (item.transactions || 0), 0)
            )}
            ...
            {formatDRELine(
              ...
              data.lineDetails?.nonOperationalRevenue?.reduce((sum: number, item: any) => sum + (item.transactions || 0), 0)
            )}
            ...
            {formatDRELine(
              ...
              data.lineDetails?.nonOperationalExpenses?.reduce((sum: number, item: any) => sum + (item.transactions || 0), 0)
            )}
                    ...
                    {expandedCategories.includes(category.name) && category.drilldown && (
                      <div className="border-t border-border bg-muted p-4 max-h-64 overflow-y-auto">
                        ...
                        <div className="space-y-2">
                          {category.drilldown.slice(0, 10).map((transaction: any) => (
                            <div
                              key={transaction.id}
